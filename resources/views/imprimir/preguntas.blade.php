        ...
        <div class="row">
            ...
            @foreach ($arrayPreguntas as $pregun)
                ...
                @endif
                        ...
                        <div class="card-body">
                            <p class="card-title sinEspacio"><b><u>{{$pregun->mujer->nombre}}</u></b></p>
                            <p class="card-text sinEspacio">({{$pregun->mujer->fechas}})</p>
                            <p class="card-text">{{$pregun->mujer->zona}}</p>                            
                            <p class="card-text tamañoLetra">{{$pregun->mujer->datos}}</p>                        
                        </div>
                    </div>
                </div>
            @endforeach                 
